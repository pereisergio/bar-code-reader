...
class TransferGuide(LineCode):
    ...
    def vencimento(self) -> date:
        return (self.date_fixed +
                timedelta(days=int(self.expiration_factor)))
...
if __name__ == '__main__':
    # code1 = '26091982900000600001772749808764090030000000'
    code1 = '23791989300000035003509090103764462000013100'
    c1 = TransferGuide(code1)
    print(c1)
    print(c1.vencimento)
    print(repr(c1))
